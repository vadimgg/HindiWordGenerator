...
| Plan local transcription workflow | P2 | done | Added `TRANSCRIPTION_PLAN.md` with local Whisper backend options, data surfaces, CLI shape, reference-text correction, standalone transcript export, optional sentence promotion, viewer integration, and phased implementation. |
