...
manual_validation_reason: "Live generation was run manually once because rerunning it after success hits accepted-output collision safety."
...
The smoke run used the configured `ollama:translategemma:12b` default. It
accepted one batch in 4.7m and wrote
