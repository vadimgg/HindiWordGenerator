...
7. If the project has a formal planning workflow, put this in the relevant
   architecture, testing, and assignment documents. Otherwise, produce a
   lightweight planning packet in the conversation or project docs.

## Lightweight Packet

Use this shape when no formal spec exists:
