...
def main() -> None:
    ...
    assert_contains("archive/agents/packs/sentence-batch-generator/AGENT.md", shared_requirements)
    assert_contains("archive/agents/packs/word-batch-generator/AGENT.md", shared_requirements)
    assert_contains("archive/docs/NO_API_AGENT_WORKFLOW.md", [
