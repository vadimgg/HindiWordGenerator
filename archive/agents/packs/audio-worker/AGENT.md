...
- Reworking planning logic unless coordinating with `agents/packs/pipeline-planner/AGENT.md`
- Expanding into complex media workflows unless asked
- Changing schema validation unless coordinating with `agents/packs/schema-guardian/AGENT.md`
